...
object FontHandler {
    ...
    fun getTypography(name: String): Typography {
        val googleFont = downloadFont(name)
        val fontFamily = createFontFamily(googleFont)
        return createTypography(fontFamily)
    }

    private fun downloadFont(name: String): GoogleFont {
        return GoogleFont(name)
    }

    private fun createFontFamily(font: GoogleFont): FontFamily {
